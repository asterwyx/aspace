...
QWidget *ListWidgetDelegate::createEditor(QWidget *parent, const QStyleOptionViewItem &option,
...
void ListWidgetDelegate::updateEditorGeometry(QWidget *editor, const QStyleOptionViewItem &option,
                                              const QModelIndex &index) const {
    Q_UNUSED(index)
